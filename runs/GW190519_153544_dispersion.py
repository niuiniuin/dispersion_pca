...
outdir = 'outdir_GW190519_153544_dispersion'
...
priors['geocent_time'] = bilby.core.prior.Uniform(
    ...
    latex_label='$t_c$',
    unit='$s$')
priors['chirp_mass'] = bilby.core.prior.Uniform(name='chirp_mass', minimum=50, maximum=80)
priors['mass_ratio'] = bilby.core.prior.Uniform(name='mass_ratio', minimum=0.1, maximum=1.0)
priors['luminosity_distance'] = bilby.gw.prior.UniformSourceFrame(name='luminosity_distance', minimum=100, maximum=8000)
