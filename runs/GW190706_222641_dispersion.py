...
outdir = 'outdir_GW190706_222641_dispersion'
...
priors['geocent_time'] = bilby.core.prior.Uniform(
    ...
    latex_label='$t_c$',
    unit='$s$')
priors['chirp_mass'] = bilby.core.prior.Uniform(name='chirp_mass', minimum=20, maximum=120)
priors['mass_ratio'] = bilby.core.prior.Uniform(name='mass_ratio', minimum=0.1, maximum=1.0)
priors['luminosity_distance'] = bilby.gw.prior.UniformSourceFrame(name='luminosity_distance', minimum=500, maximum=12000)
...
result = bilby.read_in_result(outdir+'/{}_result.json'.format(label))
