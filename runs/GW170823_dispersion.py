...
outdir = 'outdir_GW170823_dispersion'
label = 'GW170823'
...
priors['geocent_time'] = bilby.core.prior.Uniform(
    ...
    latex_label='$t_c$',
    unit='$s$')
priors['chirp_mass'] = bilby.core.prior.Uniform(name='chirp_mass', minimum=20, maximum=60)
priors['mass_ratio'] = bilby.core.prior.Uniform(name='mass_ratio', minimum=0.1, maximum=1.0)
priors['luminosity_distance'] = bilby.gw.prior.UniformSourceFrame(name='luminosity_distance', minimum=100, maximum=4500)
...
priors['A_alpha_25'] = bilby.core.prior.Uniform(name='A_alpha_25', minimum=-800.0, maximum=800.0)
priors['A_alpha_30'] = bilby.core.prior.Uniform(name='A_alpha_30', minimum=-800.0, maximum=800.0)
# priors['A_alpha_35'] = bilby.core.prior.Uniform(name='A_alpha_35', minimum=-1.0, maximum=1.0)
priors['A_alpha_40'] = bilby.core.prior.Uniform(name='A_alpha_40', minimum=-500.0, maximum=500.0)
...
file_name_LIGO = os.path.expanduser('~/works/data/GW_data/posterior_and_psd/GWTC-1_sample_release/{}_GWTC-1.hdf5'.format(label))
data_LIGO = read(file_name_LIGO, path_to_samples='Overall_posterior')
data_LIGO.generate_all_posterior_samples()
posterior_samples_LIGO = data_LIGO.samples_dict
