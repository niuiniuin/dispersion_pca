...
outdir = 'outdir_GW190513_205428_dispersion'
...
data_dict = {
    'H1':os.path.expanduser('~/works/data/GW_data/GW190513_205428/H-H1_GWOSC_4KHZ_R1-1241814039-4096.hdf5'),
    'L1':os.path.expanduser('~/works/data/GW_data/glitch_substracted/GW190513_205428/L-L1_HOFT_C01_T1700406_v4-1241812992-4096.gwf'),
    'V1':os.path.expanduser('~/works/data/GW_data/GW190513_205428/V-V1_GWOSC_4KHZ_R1-1241814039-4096.hdf5')
    }
...
for det in interferometer_names:
    ...
    if det=='L1':
        data = TimeSeries.read(data_dict[det], 'L1:DCS-CALIB_STRAIN_CLEAN_C01_T1700406_v4', start=start_time, end=end_time)
    else:
...
priors['geocent_time'] = bilby.core.prior.Uniform(
    ...
    latex_label='$t_c$',
    unit='$s$')
priors['chirp_mass'] = bilby.core.prior.Uniform(name='chirp_mass', minimum=15, maximum=50)
priors['mass_ratio'] = bilby.core.prior.Uniform(name='mass_ratio', minimum=0.1, maximum=1.0)
priors['luminosity_distance'] = bilby.gw.prior.UniformSourceFrame(name='luminosity_distance', minimum=100, maximum=6000)
